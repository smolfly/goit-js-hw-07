...
console.log(`В списке ${categoriesNumber.length} категории.`);

const getNameAndNumber = ([...array]) => {
    ...
    array.map(element => {
        ...
        console.log(`Категория: ${categoriesName}\nКоличество элементов: ${elementsNumber.length}`);
    });
}

getNameAndNumber(categoriesNumber);